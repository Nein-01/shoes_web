  ...
  <div class="main_admin d-flex" style="margin-top: 30px; margin-left: 100px">
    <div class="list_users w-50">
      ...
      <div class="list_item_user d-flex" id="user">
        ...
        <div
          class="card_product border border-light border-2 h-100 bg-light text-dark"
          style="padding: 10px"
          v-if="getindexuser"
        >
    ...
    <div class="list_products">
      ...
      <div class="list_item_product d-flex" id="product">
        ...
        >
          ...
          >
            <span class="badge bg-warning text-dark"> <i class="bi bi-pencil-square"></i> Hiệu chỉnh</span>
          </router-link>
        </div>
      </div>
      <router-link to="/addproduct">
        <button style="margin: 16px 24%" class="btn btn-danger">Thêm Sản phẩm</button>
      </router-link>
    </div>
  </div>
</template>
